          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                disabled={loading}
                className={`w-full flex items-center justify-center gap-2 px-4 py-3 rounded-2xl text-xs font-bold uppercase tracking-widest transition-all border
                ${loading
                    ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400 opacity-60 cursor-not-allowed'
                    : 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400 hover:bg-emerald-500/20 hover:border-emerald-500/40 active:scale-95'}`}
              >
                {loading
